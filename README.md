...
> Answer: Client side routing allows the user to navigate through different components without re loading the entire page everytime which gives user a really great experience compared to reloading everything they click on a single item in a shopping cart etc.
